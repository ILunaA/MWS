...
String Mobile_No0 = "+94";          // IWMI Computer
String Mobile_No1 = "+94";          // IWMI Computer
String Mobile_No2 = "+94";          // IWMI Computer
String Mobile_No3 = "+94";          // IWMI Computer
String Mobile_No4 = "+94";          // IWMI Computer
String Mobile_No5 = "+94";          // IWMI Computer
String Mobile_No6 = "+94";          // IWMI Computer
String Mobile_No7 = "+94";          // IWMI Computer
String Mobile_No8 = "+94";          // IWMI Computer
String Mobile_No9 = "+94";          // IWMI Computer
String Mobile_No10 = "+94";          // IWMI Computer
...
void setup()
{
  ...
  delay(1000);
  sendSMS(Mobile_No1, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No2, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No3, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No4, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No5, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No6, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No7, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No9, Test_SMS);//IWMI PC
  delay(1000);
  sendSMS(Mobile_No10, Test_SMS);//IWMI PC
  delay(1000);
...
void sendAlert()
{
  ...
  if(GSM_Module_Init() == OK){
    ...
    delay(1000);
    sendSMS(Mobile_No1, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No2, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No3, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No4, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No5, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No6, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No7, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No8, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No9, sz);//IWMI PC
    delay(1000);
    sendSMS(Mobile_No10, sz);//IWMI PC
    delay(1000);
  }
